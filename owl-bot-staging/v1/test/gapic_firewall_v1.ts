...
describe('v1.FirewallClient', () => {
    ...
    describe('batchUpdateIngressRules', () => {
        it('invokes batchUpdateIngressRules without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.appengine.v1.BatchUpdateIngressRulesResponse());
            ...
            assert((client.innerApiCalls.batchUpdateIngressRules as SinonStub)
    ...
    describe('createIngressRule', () => {
        it('invokes createIngressRule without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.appengine.v1.FirewallRule());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createIngressRule as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('getIngressRule', () => {
        it('invokes getIngressRule without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getIngressRule as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('updateIngressRule', () => {
        it('invokes updateIngressRule without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateIngressRule as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('deleteIngressRule', () => {
        it('invokes deleteIngressRule without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteIngressRule as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listIngressRules', () => {
        it('invokes listIngressRules without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listIngressRules as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
